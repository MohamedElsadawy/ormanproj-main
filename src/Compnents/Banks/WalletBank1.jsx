...
const WalletBank1 = ({ donationData, setDonationData }) => {
  const { id } = useParams();
  ...
  useEffect(() => {
    console.log("anatamaaaaammm", id, resource);
    if (id && resource === null) {
      axios
  ...
  console.log("wskkajd", amountField);
  return (
    <div>
      <Container fluid="lg" className="py-5 boxshadowout mandob">
        <Row style={{ justifyContent: "space-between" }}>
          <Col sm={12} md={donationData.subDonates.length > 0 ? 7 : 12}>
            ...
            <Form className="boxshadow p-3" onSubmit={handledon}>
              ...
              <Form.Group as={Row} className="mb-3" controlId="">
                ...
                <Col sm="7" md={"6"} xs={12}>
                  <Form.Control
                    type="text"
                    value={amountField === null ? "" : amountField}
                    required
                    readOnly
                  />
                </Col>
